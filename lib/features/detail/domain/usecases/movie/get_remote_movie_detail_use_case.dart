...
class GetRemoteMovieDetailUseCase {
  final MovieDetailRemoteRepository remoteRepository;

  GetRemoteMovieDetailUseCase(this.remoteRepository);

  Future<Either<Failure, MovieDetailEntity>> call(int id) async {
    return await remoteRepository.getMovieDetail(id);
  }
}
